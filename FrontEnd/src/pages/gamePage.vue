        ...
        <div class="window" style=" height:450px; max-width: 680px;">
          <slot>
            ...
            <p class="textgame" style="color: black; direction: RTL; ">
              המשחק מורכב מ-
              {{ this.$root.store.numberOfScreensInGame }} מסכים. בכל מסך יוצגו בהקטנה
              {{ this.$root.store.numberOfImagesInGame }} מהתמונות  
               שהוצגו בשלב הקודם. מתוכן יש
              לבחור את {{ this.$root.store.limitSelectInGame }} התמונות האהובות עליכם
              ביותר. כלומר, המטרה היא לבחור את התמונות שבשלב הקודם קיבלו את הציונים
              הגבוהים ביותר מבין התמונות המוצגות. 
              <br /><br />
              עבור כל בחירה נכונה תקבלו נקודה.
              <br/>
              ניתן לבטל בחירה של תמונה מסוימת על ידי לחיצה נוספת עליה.
              <br/><br/>
              שימו לב: מסיבות טכניות, המסך הראשון ייטען באיטיות.
              <br/>
