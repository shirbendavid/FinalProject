...
פרופ' נעם טרקטינסקי
    ...
    <p class="textAbout"> 
         ...
         <br/>
                        ...
                        <br/>
                        המשחק עצמו מסייע לחוקרים במחלקה לחקור נושאים
                        <br/>
     ...
     <p class="textAbout2">  
              <b>:הטכנולוגיות בהן עשינו שימוש </b></p>

                        <img class="img-tech" src="../assets/sqllogo.png" style="width: 8%;"/>
                        <img class="img-tech" src="../assets/nodejs.png" style="width: 7%;"/>
