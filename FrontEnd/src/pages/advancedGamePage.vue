        ...
        >
          <slot>
            ...
            <p class="text-advanced">
              במשחק למתקדמים המטרה היא לנסות לזהות אילו תמונות אהב שחקן אחר
              <br/>
              .במשחק, שזהותו לא ידועה! גם כאן, תקבלו נקודה אחת עבור כל זיהוי נכון
              <br/>
              !בנוסף, אין כל הגבלה על מספר הפעמים בהן ניתן לשחק משחק זה
              <br/><br/>
              .שימו לב: מסיבות טכניות, המסך הראשון יטען באיטיות 
              <br/>
