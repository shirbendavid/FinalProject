...
// Vue.use(Carousel3d);
 ...
 export default {
   data() {
    return {
      slides: [
        { id: 1, src: 'https://images.pexels.com/photos/2662116/pexels-photo-2662116.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500' },
        { id: 2, src: require('../assets/image1.jpg') },
        { id: 3, src: require('../assets/image2.jpg') },
        { id: 4, src: require('../assets/image3.jpg') },
        { id: 5, src: require('../assets/image4.jpg') },
        { id: 6, src: require('../assets/image5.jpg') },
        { id: 7, src: require('../assets/image6.jpg') },
        { id: 8, src: require('../assets/image7.jpg') },
      ],
      image: {
