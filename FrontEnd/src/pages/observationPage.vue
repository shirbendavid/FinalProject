  ...
  <div class="container">
        ...
        <div class="popup-modal" v-if="isVisible">
            <div class="window" style=" height:550px; max-width: 900px;">
                ...
                <br/>
                <p class="textobs">
                   בשלב הראשון של המשחק, עליכם לצפות בלפחות {{ this.$root.store.minImagesRating }} תמונות, ולתת להן ציון שמשקף עד כמה
                   <br/>
                   ...
                   <br/>
                   .בדרך זו, יתקבלו ציוניכם לכל {{ this.$root.store.minImagesRating }} התמונות
                   <br/><br/>
                   כאשר תסיימו להעריך את {{ this.$root.store.minImagesRating }} התמונות תוכלו לבחור בין האפשרות לראות עוד תמונות ולתת
                   <br/>
